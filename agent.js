...
- Убирай вводные слова, повторы, «воду» ("надо бы", "не забыть", "вроде как", "в принципе").
- Сохраняй весь смысл и важные детали, но без лишних слов. Деталями наполняй description, не заголовок.
Примеры: «надо бы наконец-то написать тот самый регламент по ревью спеков» → title: "Написать регламент ревью спеков". «хочу обсудить с командой как мы будем приоритизировать бэклог» → topic: "Приоритизация бэклога".
