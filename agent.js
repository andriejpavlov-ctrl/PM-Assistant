...
• priority — "P1" (срочно и важно) | "P2" (важно, не срочно) | "P3" (срочно, не важно) | "P4" (ни то, ни другое). Срочность определяй по словам: «срочно/asap/сегодня/завтра» → высокая; «на неделе» → средняя; «через месяц/потом» → низкая. Важность: «важно/критично/блокер» → высокая. Если непонятно — "".
...
{"title":"...","description":"...","people":["..."],"projects":["..."],"priority":"P1|P2|P3|P4|","deadline":null|"YYYY-MM-DD","tags":["..."]}
...
У каждой карточки есть title, description, people, projects, priority (P1-P4), deadline, tags.
