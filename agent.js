...
• projects — массив проектов/продуктов. ПО УМОЛЧАНИЮ []. Каждый элемент — ОБЪЕКТ {"name":"...","confidence":"high"|"low","sameAs":"точное название из списка известных проектов или null"}.
  КОГДА вообще добавлять проект (иначе оставляй [] — НЕ угадывай «по смыслу»):
   ...
   2) есть слово с ЗАГЛАВНОЙ буквы НЕ в начале предложения и это НЕ имя собственное (не имя/фамилия человека, не город, не компания) — вероятно внутреннее кодовое имя продукта. Если уверен — confidence "high"; если сомневаешься, проект ли это вообще, — всё равно верни его, но confidence "low" (приложение переспросит пользователя).
  Нарицательные слова со строчной буквы (полис, биллинг, отчёт), отделы, технологии и общие термины — НЕ проект.
