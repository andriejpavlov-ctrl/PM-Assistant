...
- Имя человека всегда приводи к полной официальной форме, разворачивая уменьшительно-ласкательные: Оля→Ольга, Лена→Елена, Катя→Екатерина, Дима→Дмитрий, Миша→Михаил, Наташа→Наталья, Ваня→Иван, Коля→Николай, Петя→Пётр, Таня→Татьяна, Маша→Мария, Аня→Анна, Саша→Александр, Серёжа→Сергей и т.п. Фамилию сохраняй как есть.
- Пример: «Оля Демидова» → person: "Ольга Демидова"; «обсудить с Олей» → person: "Ольга".
- Если ниже передан список известных коллег и имя соответствует одному из них — верни ИМЕННО его полное имя с фамилией (так разные варианты одного человека объединяются).
